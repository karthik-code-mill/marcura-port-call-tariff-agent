...
cd E:\app\code\ai\agentic-ai\marcura-port-call-tariff-agent\src; python -m orchestrator.document_prep_pipeline --country "South Africa" --version-tag FY2025-26-v3.3 --page-start 5 --page-end 13 --two-column-layout

python -m orchestrator.pipeline --country "South Africa" --port Durban --gt 51300 --vessel-type "Bulk Carrier" --voyage inbound --after-hours --days-in-port 2